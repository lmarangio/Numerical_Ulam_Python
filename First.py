...
clf = MLPRegressor(alpha=0.0001, hidden_layer_sizes = (100,100), max_iter = 50000, activation = 'relu', verbose = 'True', learning_rate = 'adaptive')
a = clf.fit(XN, YN)
